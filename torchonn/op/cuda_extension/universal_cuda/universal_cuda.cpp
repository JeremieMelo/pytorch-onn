...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("universal_transform", &universal_transform,
        "Universal frequency transform");
  m.def("inverse_universal_transform", &inverse_universal_transform,
        "Inverse universal frequency transform");
}
